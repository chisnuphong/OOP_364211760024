...
def display_vehicle():
    if len(my_vihecle) ==0:
        ...
        print(f'You had {len(my_vihecle)} following:')
        for x in my_vihecle:
            x.vihecle_detail()
        print("\n")
...
def input_vehicle_data():
    ...
    my_vihecle.append(Vihecle(brand,model,color,maxspeed,price))
    print("\n-----------------------------------")
...
#v1 = Vihecle(vm[0],vm[1],vm[2],vm[3],vm[4])
# display all object attributes
#v1.vihecle_detail()

#vm = input_vehicle_data()
# create object of Vehicle class
#v2 = Vihecle(vm[0],vm[1],vm[2],vm[3],vm[4])
# display all object attributes
#v2.vihecle_detail()